...
android {
    ...
    defaultConfig {
        ...
        // Açıklama: Hugging Face API Token'ını güvenli şekilde enjekte ediyoruz
        manifestPlaceholders["huggingFaceToken"] = project.findProperty("HUGGING_FACE_TOKEN") ?: ""
    }
    ...
    // Açıklama: Performans - APK boyutunu düşürmek için ABI split (Chaquopy ile uyumlu)
    splits {
        abi {
            isEnable = false // Chaquopy ile uyumluluk için kapatıldı
        }
    }
}
...
dependencies {
    ...
    // OkHttp - Açıklama: HuggingFace API istekleri için
